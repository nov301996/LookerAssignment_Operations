view: c_vw_mtwd2 {
  ...
  derived_table: {
    sql: select  workflow_dataset_instance_map_id,workflow_instance_id,dataset_instance_direction,dataset_instance_id
      from m_track_workflow_dataset_instance_map where lower(dataset_instance_direction)='output' ;;
  }
