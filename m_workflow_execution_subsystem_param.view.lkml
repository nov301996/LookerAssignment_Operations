view: m_workflow_execution_subsystem_param {
  sql_table_name: dbo.M_WORKFLOW_EXECUTION_SUBSYSTEM_PARAM ;;
  ...
  dimension: workflow_execution_subsystem_param_id {
    type: number
    sql: ${TABLE}.WORKFLOW_EXECUTION_SUBSYSTEM_PARAM_ID ;;
  }
